...
% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ %
\newcommand{\thesemester}{Fall 2014}
\newcommand{\themidterm}{CS70 Midterm 1 Review}
\newcommand{\theauthors}{Kyle Lian, Andrew Liu, Jyo Shim, Vikram Sreekanti}
\newcommand{\theorganization}{Eta Kappa Nu, Mu Chapter \\
University of California, Berkeley}
\newcommand{\thedate}{February 14, 2014}
...
\begin{frame}[fragile]
  \frametitle{Topics}
  \begin{itemize}
    \item Propositions and Proof Techniques
    \item Induction
...
\begin{frame}[fragile]
  \frametitle{Propositions}
    \begin{itemize}
        \item Definition:
        \begin{itemize}
            \item A statement which is either true or false
        \end{itemize}
        
        \item Propositions can be joined together into propositional forms.
            \begin{itemize}
                \item Conjunction: $P \wedge Q$. True only when both P and Q are true.
                \item Disjunction: $P \vee Q$. True when at least one of P and Q is true.
                \item Negation: $\neg P$. True when P is false.
                \item Implication: $P \Rightarrow Q$. This is the same as "if P, then Q."
                    \begin{itemize}
                        \item Contrapositive $\neg Q \Rightarrow \neg P$. Logically equivalent to implication.
                        \item Converse $Q \Rightarrow P$. NOT logically equivalent to implication.
                    \end{itemize}
            \end{itemize}
    \end{itemize}   
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Quantifiers and Negation}
    \begin{itemize}
        \item Use De Morgan's Law for negations.
        \begin{itemize}
            \item $\neg (P \wedge Q) \Leftrightarrow (\neg P) \vee (\neg Q)$
            \item $\neg (P \vee Q) \Leftrightarrow (\neg P) \wedge (\neg Q)$
        \end{itemize}
        
        \item Example (Sahai Sp13 Midterm 1 #1d)
            $\neg (\forall x \in \mathbb{N}$ $\exists y \in \mathbb{N}$ $P(x, y)) \Rightarrow (\exists x \in \mathbb{N}$ $\forall y \in \mathbb{N}$ $\neg P(x, y))$
    \end{itemize}   
\end{frame}
